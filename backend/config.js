...
const TransportTrips = sequelize.define("TransportTrips", {
  ...
  driver_loading_date: { type: DataTypes.DATEONLY, allowNull: true },
  ...
  company_loading_date: { type: DataTypes.DATEONLY, allowNull: true  },
  ...
  aging_date: { type: DataTypes.DATEONLY,  allowNull: true  },
